...
<div class="form-group {{ $errors->has('namefour') ? 'has-error' : ''}}">
    <label for="namefour" class="control-label">{{ 'Tên Slider 4' }}</label>
    <input class="form-control" name="namefour" type="text" id="namefour" value="{{ isset($slider->namethree) ? $slider->namefour : old('namefour')}}" >
