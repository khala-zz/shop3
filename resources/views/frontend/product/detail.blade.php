										...
										<div class="product shadow-media">
											...
											<div class="product-details">
												...
												<div class="ratings-container">
													...
													<!-- end hien thi rating -->
													<a href="{{ route('product.detail',['slug' => slugify($product_new -> title,'-'),'id' => $product_new -> id.'?r=product-tab-reviews'])}}" class="link-to-tab rating-reviews">( {{$product_new -> reviews -> count()}} Đánh giá )</a>
												</div>
											</div>
										</div>
									@empty
