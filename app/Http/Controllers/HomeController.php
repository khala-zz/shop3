...
class HomeController extends Controller
{
    ...
    public function home(){
    	...
    	$products_sale = $this -> product  -> select('id','image','title','price','new','discount','pro_total_rating','pro_total_number') -> where('is_active',1) -> where('discount','<>',null) ->latest() -> take(3) -> get();
