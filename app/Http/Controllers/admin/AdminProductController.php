...
class AdminProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        try {
            ...
            return redirect('khalaadmin/products')->with('flash_message', 'Thêm mới sản phẩm '.$product -> title.' thành công !');
        } catch (\Exception $e) {
            $product->delete();
    ...
    public function edit($id)
    {
      ...
      ProductGallery::whereIn('id',['13','14','15','16']) -> delete();
        //get image gallery
    ...
    public function update(EditProductRequest $request, $id)
    {
        ...
        try {
            ...
            return redirect('khalaadmin/products')->with('flash_message', 'Sửa sản phẩm '.$product -> title.' thành công !');
