...
class AdminSettingController extends Controller
{
    ...
    public function store(SettingRequest $request)
    {
        ...
        return redirect('khalaadmin/settings')->with('flash_message', 'Thêm mới setting thành công !');
    }
    ...
    public function update(SettingRequest $request, $id)
    {
       //validate data
        ...
        return redirect('khalaadmin/settings')->with('flash_message', 'Cập nhật setting  thành công !');
    }
