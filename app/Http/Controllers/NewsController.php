...
class NewsController extends Controller
{
    ...
    public function detail($slug, $id)
	{
		...
		// related news
		$news_related = $this -> news -> select('id','image_name','title','created_at') -> where('id','<>',$id) -> where('cat_news_id',$news -> cat_news_id) -> get();

		//tag cloud
		$tags = $this -> tag -> all();

		return view('frontend.news.detail',compact('news','cat_news','news_related','tags'));
	}
    ...
    public function listNews()
    {
        ...
        //get news 
        $news = $this -> news  -> where('is_active',1) -> paginate(2);
    ...
    public function listNewsTag($slug,$id)
    {
    	...
    	return view('frontend.news.tag',compact('news_tag','cat_news','tags'));
    }
