        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body">
                        ...
                        <form method="POST" action="<?php echo e(url('/khalaadmin/categories')); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>


                            <?php echo $__env->make('admin.pages.category.form', ['formMode' => 'create'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop2\resources\views/admin/pages/category/create.blade.php ENDPATH**/ ?>