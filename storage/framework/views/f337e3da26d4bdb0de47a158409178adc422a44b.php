							...
							<div class="sidebar-content">
								<div class="sticky-sidebar" data-sticky-options="{'top': 10}">
									<div class="filter-actions">
										...
										<a href="#" onclick="location.href='<?php echo e(url('cua-hang')); ?>';" class="filter-clean text-primary">Bỏ lọc</a>
									</div>
									<div class="widget widget-collapsible">
                                        ...
                                        <ul class="widget-body filter-items search-ul">
                                            ...
                                            <li>
                                                <a href="<?php echo e(url('cua-hang?category_id='.$item -> id)); ?>" class="<?php echo e(count($item->children) ? 'show' :''); ?> <?php echo e(Request::get('category_id') == $item -> id ? 'active-filters' :''); ?>" ><?php echo e($item->title); ?></a>
                                                 <!-- submenu -->
                                                 <?php if(count($item->children)): ?>
                        
								                    <?php echo $__env->make('frontend.product.menusub',['childs' => $item -> children], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
								                 <?php endif; ?>
								                 <!-- end submenu -->
									...
									<div class="widget widget-collapsible">
										...
										<div class="widget-body">
											<form action="<?php echo e(url('cua-hang')); ?>">
									...
									<div class="widget widget-collapsible">
										...
										<ul class="widget-body filter-items-khala">
												...
												<?php $__currentLoopData = $brands_count; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<li><a href="<?php echo e(url('cua-hang?brand_filter='.$brand -> id)); ?>" class="<?php echo e(Request::get('brand_filter') == $brand -> id ? 'active-filters' :''); ?>"><?php echo e($brand -> title); ?><span><?php echo e($brand -> products_count); ?></span></a>
...
'margin': 20											}">
						...
						<div class="col-lg-9 main-content">
							...
							<div class="row cols-2 cols-sm-3 product-wrapper">
								...
								<div class="product-wrap">
									Không có sản phẩm phù hợp với thông tin bạn lọc vui lòng <a href="<?php echo e(url('cua-hang')); ?>"><strong>tìm lại</strong> </a>, cám ơn !
								</div>
								<?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop2\resources\views/frontend/shop.blade.php ENDPATH**/ ?>