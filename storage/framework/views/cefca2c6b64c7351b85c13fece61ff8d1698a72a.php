...
<section class="content-header">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <h1>
                Sửa vai trò <strong class="panel-color-id" >#<?php echo e($role->id); ?></strong>
            </h1>
            <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="<?php echo e(url('/khalaadmin/roles/' . $role->id)); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
                        <?php echo e(method_field('PATCH')); ?>

                        <?php echo e(csrf_field()); ?>


                        <?php echo $__env->make('admin.pages.roles.form', ['formMode' => 'edit'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop2\resources\views/admin/pages/roles/edit.blade.php ENDPATH**/ ?>