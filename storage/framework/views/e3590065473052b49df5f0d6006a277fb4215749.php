...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        ...
        <h1>
            Sửa danh mục sản phẩm <strong class="panel-color-id" >#<?php echo e($category->id); ?></strong>
        </h1>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel-body">
                        ...
                        <form method="POST" action="<?php echo e(url('/khalaadmin/categories/' . $category->id)); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
                            <?php echo e(method_field('PATCH')); ?>

                            <?php echo e(csrf_field()); ?>


                            <?php echo $__env->make('admin.pages.category.form', ['formMode' => 'edit'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop2\resources\views/admin/pages/category/edit.blade.php ENDPATH**/ ?>