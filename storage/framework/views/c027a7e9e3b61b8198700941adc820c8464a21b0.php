...
<main class="main">
    <div class="page-content">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            <form class="ml-lg-2 pt-8 pb-10 pl-4 pr-4 pl-lg-6 pr-lg-6" method="POST" action="<?php echo e(route('front-login')); ?>">
                 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop2\resources\views/auth/login_front.blade.php ENDPATH**/ ?>