            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo e(url('/news')); ?>" class="active">Tin tức</a></li>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\shop2\resources\views/frontend/news/list.blade.php ENDPATH**/ ?>